...
if __name__ == "__main__":
    ...
    observation, reward, sensors, parkpos, rotation = loop.run_until_complete(main(env,7))
        ...
        while reward < 500:
            while sensors[0] > 30 and sensors[1] > 30 and sensors[2] > 30 and sensors[3] > 30 and sensors[4] > 30 and sensors[5] > 30 and sensors[6] > 30 and sensors[7] > 30 and reward < 500:
                ...
                while rotation > -(math.pi/11) and observation[0]<parkpos[0] and observation[2] != 0:
                    observation, reward, sensors, parkpos, rotation = loop.run_until_complete(main(env,5))
                    observation, reward, sensors, parkpos, rotation = loop.run_until_complete(main(env,3))
                    print(rotation > -(math.pi/11) and observation[0]>parkpos[0] and observation[1] < parkpos[1])
                    print(reward)
                    print(sensors[0] > 30 and sensors[1] > 30 and sensors[2] > 30 and sensors[3] > 30 and sensors[4] > 30 and sensors[5] > 30 and sensors[6] > 30 and sensors[7] > 30 and reward < 500)
    ...
    if bereich == 4:
        if reward < 500:
            while sensors[0] > 30 and sensors[2] > 30 and sensors[4] > 30 and sensors[6] > 30 :
